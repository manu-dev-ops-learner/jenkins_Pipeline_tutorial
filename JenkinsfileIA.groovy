    ...
    stages {
        ...
        stage('Publish BackEnd IA image to Nexus'){
            ...
            steps{
                 withCredentials([string(credentialsId: 'nexuspassword', variable: 'nexus')]) {
                    ...
                    echo  'Push BackEnd IA image to Alteca Nexus success'
                }
        }
        ...
        stage('Publish FrontEnd IA image to Nexus'){
            steps{
               withCredentials([string(credentialsId: 'nexuspassword', variable: 'nexus')]) {
                    ...
                    echo  'Push FrontEnd IA image to Alteca Nexus success'
                }
        }
        ...
        stage('Run BackEnd IA in the jenkins host') {
            steps {
               ...
               sh 'docker run -d -it -p 5000:5000 --name ia_backend srvdoadop2:9080/testbackendia:1.0.0' 
                echo ' Run success'
            }
        }
        ...
        stage('Run FrontEnd IA in the jenkins host') {
            steps {
               ...
               sh 'docker run -d -it -p 4000:3000 --name ia_frontend srvdoadop2:9080/testfrontendia:1.0.0' 
                echo ' Run success'
            }
        }
